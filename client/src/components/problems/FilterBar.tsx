...
export function FilterBar({ filters, onChange }: Props) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 py-3 px-4 bg-slate-50 dark:bg-slate-800/50 border-b border-slate-200 dark:border-slate-700">
          ...
          {STATUS_OPTIONS.map((s) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'px-2.5 py-1 text-xs rounded-lg font-medium capitalize transition-colors cursor-pointer',
