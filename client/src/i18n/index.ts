...
export interface Translations {
  ...
  table: { rating: string; id: string; problem: string; contest: string; status: string; time: string; problems: string; perPage: string; page: string; of: string; noResults: string };
